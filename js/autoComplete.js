const getAutoCompleteAdresses = async function getAutoCompleteAdresses(apiKeyAutocomplete, text) {
    try {
        const response = await fetch(`https://api.geoapify.com/v1/geocode/autocomplete?text=${text}&apiKey=${apiKeyAutocomplete}`)
